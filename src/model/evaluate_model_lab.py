...
from src.common.other_utils import setup_logger, plot_predictions, plot_histogram, save_metrics_to_txt, load_case_config
...
if __name__ == "__main__":
    ...
    _, _, X_test, _, _, y_test, norm_params = make_lab_dataset()
